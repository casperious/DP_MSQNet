...
#     Here, if we have an arg for animal, update the path_data.
    ...
    executor.train(args.epoch_start, args.epochs,args.animal)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_every", default=50, type=int, help="Test the model every this number of epochs")
#     parser.add_argument("--gpu", default='')
    parser.add_argument("--gpu", default='1', type=int, help="GPU ids for multi-GPU training")
